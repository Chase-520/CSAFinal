...
public class VNEngine extends Application {
    ...
    public void start(Stage stage) {
        ...
        controller.registerScene("ch1_2", () -> new GameScene(1280, 720, "bg/bg001.png", "H:\\git\\CSAFinal\\VisualNovel\\src\\scripts\\test.json"));
        controller.registerScene("ch1_3", () -> new GameScene(1280, 720, "bg/ev003el.png", "H:\\git\\CSAFinal\\VisualNovel\\src\\scripts\\test.json"));
